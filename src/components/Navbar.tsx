         ...
         <div
            ...
            <div className='w-full h-[32%] flex flex-col justify-between items-center relative'>
               <span
                  ...
                  } transition top-0 h-[2.2px] bg-slate-900 rounded-2xl`}></span>
               <span
                  className={`w-[50%] absolute ${
                     nav && 'opacity-0'
                  } transition top-2 h-[2.2px] bg-slate-900 rounded-2xl`}></span>
               <span
                  className={`w-[50%] absolute ${
                     nav && '-rotate-45 -translate-y-2'
                  } transition top-4 h-[2.2px] bg-slate-900 rounded-2xl`}></span>
            </div>
         </div>
      </div>
   );
